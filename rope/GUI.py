...
LANGUAGE_DOMAIN_NAME = "gui_trans"
lang_zh = gettext.translation(
    LANGUAGE_DOMAIN_NAME, localedir="./rope/locale", languages=["zh"]
)
lang_zh.install(LANGUAGE_DOMAIN_NAME)
_ = lang_zh.gettext
...
class GUI(tk.Tk):
    ...
    def create_gui(self):
        ...
        self.widget["StartButton"] = GE.Button(
            frame, "StartRope", 1, self.load_all, None, "control", 10, 9, width=200
        )

        self.widget["OutputFolderButton"] = GE.Button(
            frame,
            "OutputFolder",
            1,
            self.select_save_video_path,
            None,
            "control",
            x=240,
            y=1,
        ...
        # Buttons
        self.widget["VideoFolderButton"] = GE.Button(
            frame,
            "LoadTVideos",
            2,
        ...
        # Input Videos Canvas
        self.target_media_canvas = tk.Canvas(
        ...
        self.target_media_canvas.create_text(
            8,
            20,
            anchor="w",
            fill="grey25",
        ...
        self.static_widget["input_videos_scrollbar"] = GE.Scrollbar_y(
            scroll_canvas, self.target_media_canvas
        )
        ...
        self.widget["AudioButton"] = GE.Button(
            frame, "Audio", 2, self.toggle_audio, None, "control", x=0, y=0, width=100
        )

        frame = tk.Frame(preview_data, style.canvas_frame_label_2, height=24, width=100)
        frame.grid(row=0, column=1)
        self.widget["MaskViewButton"] = GE.Button(
            frame,
            "MaskView",
            2,
            self.toggle_maskview,
            None,
            "control",
            x=0,
            y=0,
        ...
        self.widget["PreviewModeTextSel"] = GE.TextSelection(
            frame,
            "PreviewModeTextSel",
            "",
            2,
        ...
        self.video_slider = GE.Timeline(
            slider_frame, self.widget, self.temp_toggle_swapper, self.add_action
        )

        # Markers
        self.markers_canvas = tk.Canvas(
            center_frame, style.canvas_frame_label_2, height=20
        )
        ...
        # Left Side
        leftplay_frame = tk.Frame(
            preview_frame, style.canvas_frame_label_2, height=30, width=100
        )
        leftplay_frame.grid(row=0, column=0, sticky="NEWS", pady=0)

        cente_frame = tk.Frame(
            preview_frame,
            style.canvas_frame_label_2,
            height=30,
        )
        ...
        play_control_frame = tk.Frame(
            cente_frame, style.canvas_frame_label_2, height=30, width=270
        )
        play_control_frame.place(anchor="c", relx=0.5, rely=0.5)

        column = 0
        col_delta = 50
        self.widget["TLBegButton"] = GE.Button(
            play_control_frame,
            "TLBeginning",
            2,
        ...
        column += col_delta
        self.widget["TLLeftButton"] = GE.Button(
            play_control_frame,
            "TLLeft",
            2,
            self.preview_control,
        ...
        column += col_delta
        self.widget["TLRecButton"] = GE.Button(
            play_control_frame,
            "Record",
            2,
        ...
        column += col_delta
        self.widget["TLPlayButton"] = GE.Button(
            play_control_frame,
            "Play",
            2,
        ...
        column += col_delta
        self.widget["TLRightButton"] = GE.Button(
            play_control_frame,
            "TLRight",
            2,
            self.preview_control,
        ...
        # Spacing
        right_playframe = tk.Frame(
            preview_frame, style.canvas_frame_label_2, height=30, width=100
        )
        right_playframe.grid(row=0, column=2, sticky="NEWS", pady=0)
        self.widget["AddMarkerButton"] = GE.Button(
            right_playframe,
            "AddMarkerButton",
            2,
            self.update_marker,
        ...
        self.widget["DelMarkerButton"] = GE.Button(
            right_playframe,
            "DelMarkerButton",
            2,
            self.update_marker,
        ...
        self.widget["PrevMarkerButton"] = GE.Button(
            right_playframe,
            "PrevMarkerButton",
            2,
            self.update_marker,
        ...
        self.widget["NextMarkerButton"] = GE.Button(
            right_playframe,
            "NextMarkerButton",
            2,
            self.update_marker,
        ...
        self.widget["ClearFacesButton"] = GE.Button(
            button_frame,
            "ClearFaces",
            2,
            self.clear_faces,
        ...
        # Buttons
        button_frame = tk.Frame(
            mf_frame, style.canvas_frame_label_2, height=100, width=112
        )
        button_frame.grid(
            row=0,
            column=0,
        ...
        self.widget["DelEmbedButton"] = GE.Button(
            button_frame,
            "DelEmbed",
            2,
            self.delete_merged_embedding,
            None,
            "control",
            x=0,
            y=0,
        ...
        self.merged_embeddings_text = tk.Entry(
            button_frame, style.entry_2, textvariable=self.merged_embedding_name
        )
        self.merged_embeddings_text.place(x=8, y=37, width=96, height=20)
        self.merged_embeddings_text.bind(
            "<Return>",
        ...
        parameters_control_frame = tk.Frame(
            r_frame, style.canvas_frame_label_2, bd=0, width=width, height=42
        )
        parameters_control_frame.grid(
            row=0, column=0, columnspan=2, sticky="NEWS", pady=0, padx=0
        )
        ...
        frame = tk.Frame(
            parameters_control_frame, style.canvas_frame_label_2, height=42, width=100
        )
        frame.grid(row=0, column=0)
        self.widget["SaveParamsButton"] = GE.Button(
            frame,
            "SaveParamsButton",
            2,
            self.parameter_io,
        ...
        frame.grid(row=0, column=1)
        self.widget["LoadParamsButton"] = GE.Button(
            frame,
            "LoadParamsButton",
            2,
            self.parameter_io,
        ...
        frame.grid(row=0, column=2)
        self.widget["DefaultParamsButton"] = GE.Button(
            frame,
            "DefaultParamsButton",
            2,
            self.parameter_io,
        ...
        parameters_canvas = tk.Frame(
            canvas, style.canvas_frame_label_3, bd=0, width=width, height=970
        )
        ...
        # Threshhold
        self.widget["ThresholdSlider"] = GE.Slider2(
            parameters_canvas,
            "ThresholdSlider",
            _("Similarity Threshhold"),
            3,
            self.update_data,
            "parameter",
            398,
        ...
        # Orientation
        self.widget["OrientSwitch"] = GE.Switch2(
            parameters_canvas,
            "OrientSwitch",
            _("Orientation"),
            3,
        ...
        row += switch_delta
        self.widget["OrientSlider"] = GE.Slider2(
            parameters_canvas,
            "OrientSlider",
            _("Angle"),
            3,
        ...
        # Strength
        self.widget["StrengthSwitch"] = GE.Switch2(
            parameters_canvas,
            "StrengthSwitch",
            _("Strength"),
            3,
        ...
        row += switch_delta
        self.widget["StrengthSlider"] = GE.Slider2(
            parameters_canvas,
            "StrengthSlider",
            _("Amount"),
            3,
        ...
        # Border
        self.widget["BorderTopSlider"] = GE.Slider2(
            parameters_canvas,
            "BorderTopSlider",
            _("Top Border Distance"),
            3,
            self.update_data,
            "parameter",
            398,
        ...
        row += row_delta
        self.widget["BorderSidesSlider"] = GE.Slider2(
            parameters_canvas,
            "BorderSidesSlider",
            _("Sides Border Distance"),
            3,
            self.update_data,
            "parameter",
            398,
        ...
        row += row_delta
        self.widget["BorderBottomSlider"] = GE.Slider2(
            parameters_canvas,
            "BorderBottomSlider",
            _("Bottom Border Distance"),
            3,
            self.update_data,
            "parameter",
            398,
        ...
        row += row_delta
        self.widget["BorderBlurSlider"] = GE.Slider2(
            parameters_canvas,
            "BorderBlurSlider",
            _("Border Blend"),
            3,
        ...
        # Diff
        self.widget["DiffSwitch"] = GE.Switch2(
            parameters_canvas,
            "DiffSwitch",
            _("Differencing"),
            3,
        ...
        row += switch_delta
        self.widget["DiffSlider"] = GE.Slider2(
            parameters_canvas,
            "DiffSlider",
            _("Amount"),
            3,
        ...
        # Occluder
        self.widget["OccluderSwitch"] = GE.Switch2(
            parameters_canvas,
            "OccluderSwitch",
            _("Occluder"),
            3,
        ...
        row += switch_delta
        self.widget["OccluderSlider"] = GE.Slider2(
            parameters_canvas,
            "OccluderSlider",
            _("Size"),
            3,
        ...
        # FaceParser - Mouth
        self.widget["MouthParserSwitch"] = GE.Switch2(
            parameters_canvas,
            "MouthParserSwitch",
            _("Mouth Parser"),
            3,
        ...
        row += switch_delta
        self.widget["MouthParserSlider"] = GE.Slider2(
            parameters_canvas,
            "MouthParserSlider",
            _("Amount"),
            3,
        ...
        # FaceParser - Face
        self.widget["FaceParserSwitch"] = GE.Switch2(
            parameters_canvas,
            "FaceParserSwitch",
            _("Face Parser"),
            3,
        ...
        row += switch_delta
        self.widget["FaceParserSlider"] = GE.Slider2(
            parameters_canvas,
            "FaceParserSlider",
            _("Amount"),
            3,
        ...
        # CLIP
        self.widget["CLIPSwitch"] = GE.Switch2(
            parameters_canvas,
            "CLIPSwitch",
            _("Text-Based Masking"),
            3,
            self.update_data,
            "parameter",
            398,
        ...
        row += switch_delta
        self.widget["CLIPTextEntry"] = GE.Text_Entry(
            parameters_canvas,
            "CLIPTextEntry",
            _("Text-Based Masking"),
            3,
        ...
        row += row_delta
        self.widget["CLIPSlider"] = GE.Slider2(
            parameters_canvas,
            "CLIPSlider",
            _("Amount"),
            3,
        ...
        # Blur
        self.widget["BlendSlider"] = GE.Slider2(
            parameters_canvas,
            "BlendSlider",
            _("Overall Mask Blend"),
            3,
            self.update_data,
            "parameter",
            398,
        ...
        # Color Adjustments
        self.widget["ColorSwitch"] = GE.Switch2(
            parameters_canvas,
            "ColorSwitch",
            _("Color Adjustments"),
            3,
        ...
        row += switch_delta
        self.widget["ColorRedSlider"] = GE.Slider2(
            parameters_canvas,
            "ColorRedSlider",
            _("Red"),
            3,
        ...
        row += row_delta
        self.widget["ColorGreenSlider"] = GE.Slider2(
            parameters_canvas,
            "ColorGreenSlider",
            _("Green"),
            3,
        ...
        row += row_delta
        self.widget["ColorBlueSlider"] = GE.Slider2(
            parameters_canvas,
            "ColorBlueSlider",
            _("Blue"),
            3,
        ...
        self.widget["FaceAdjSwitch"] = GE.Switch2(
            parameters_canvas,
            "FaceAdjSwitch",
            _("Input Face Adjustments"),
            3,
            self.update_data,
            "parameter",
            398,
        ...
        row += switch_delta
        self.widget["KPSXSlider"] = GE.Slider2(
            parameters_canvas,
            "KPSXSlider",
            "KPS - X",
            3,
        ...
        row += row_delta
        self.widget["KPSYSlider"] = GE.Slider2(
            parameters_canvas,
            "KPSYSlider",
            "KPS - Y",
            3,
        ...
        row += row_delta
        self.widget["KPSScaleSlider"] = GE.Slider2(
            parameters_canvas,
            "KPSScaleSlider",
            "KPS - Scale",
            3,
        ...
        row += row_delta
        self.widget["FaceScaleSlider"] = GE.Slider2(
            parameters_canvas,
            "FaceScaleSlider",
            _("Face Scale"),
            3,
        ...
        # Cats and Dogs
        self.widget["ThreadsSlider"] = GE.Slider2(
            parameters_canvas,
            "ThreadsSlider",
            _("Threads"),
            3,
        ...
        row += row_delta
        self.widget["DetectTypeTextSel"] = GE.TextSelection(
            parameters_canvas,
            "DetectTypeTextSel",
            _("Detection Type"),
            3,
        ...
        row += row_delta
        self.widget["DetectScoreSlider"] = GE.Slider2(
            parameters_canvas,
            "DetectScoreSlider",
            _("Detect Score"),
            3,
        ...
        row += row_delta
        self.widget["RecordTypeTextSel"] = GE.TextSelection(
            parameters_canvas,
            "RecordTypeTextSel",
            _("Record Type"),
            3,
        ...
        row += row_delta
        self.widget["VideoQualSlider"] = GE.Slider2(
            parameters_canvas,
            "VideoQualSlider",
            _("FFMPEG Quality"),
            3,
        ...
        self.status_left_label = tk.Label(
            ...
            style.donate_1,
            cursor="hand2",
            text=_(" Questions/Help/Discussions (Discord)"),
        )
        self.status_left_label.grid(row=0, column=0, sticky="NEWS")
        self.status_left_label.bind(
            "<Button-1>", lambda e: self.callback("https://www.baidu.com")
        )

        self.status_label = tk.Label(
            bottom_frame, style.donate_1, text=_("Rope Github")
        )
        ...
        self.donate_label = tk.Label(
            bottom_frame,
            style.donate_1,
            text=_("Enjoy Rope? Please Support! (Paypal) "),
            anchor="e",
        )
        self.donate_label.grid(row=0, column=2, sticky="NEWS")
        self.donate_label.bind(
            "<Button-1>",
            lambda e: self.callback("https://www.baidu.com"),
        )
    ...
    def update_data(self, mode, name, use_markers):
        ...
        if mode == "parameter":
            ...
            if use_markers:
                ...
                self.add_action(
                    "get_requested_video_frame_without_markers", self.video_slider.get()
                )
    ...
    def source_faces_mouse_wheel(self, event):
        ...
        center = (
            self.source_faces_canvas.yview()[1] - self.source_faces_canvas.yview()[0]
        ) / 2
    ...
    def target_videos_mouse_wheel(self, event):
        ...
        # Center of visible canvas as a percentage of the entire canvas
        center = (
            self.target_media_canvas.yview()[1] - self.target_media_canvas.yview()[0]
        ) / 2
    ...
    def initialize_gui(self):
        ...
        self.video_image = cv2.cvtColor(
            cv2.imread("./rope/media/splash.png"), cv2.COLOR_BGR2RGB
        )
        self.resize_image()
    ...
    def select_video_path(self):
        ...
        self.json_dict["source videos"] = filedialog.askdirectory(
            title="Select Target Videos Folder", initialdir=temp
        )
    ...
    def select_save_video_path(self):
        ...
        self.json_dict["saved videos"] = filedialog.askdirectory(
            title="Select Save Video Folder", initialdir=temp
        )
    ...
    def load_source_faces(self):
        ...
        try:
            ...
            for j in range(len(temp0)):
                ...
                self.source_faces[j]["TKButton"] = tk.Button(
                    self.merged_faces_canvas,
                ...
                self.source_faces[j]["TKButton"].bind(
                    "<ButtonRelease-1>",
                    lambda event, arg=j: self.toggle_source_faces_buttons_state(
                        event, arg
                    ),
                )
                self.source_faces[j]["TKButton"].bind(
                    "<Shift-ButtonRelease-1>",
                    lambda event, arg=j: self.toggle_source_faces_buttons_state_shift(
                        event, arg
                    ),
                )
                self.source_faces[j]["TKButton"].bind(
                ...
                self.merged_faces_canvas.create_window(
                    (j // 4) * 92,
                    8 + (22 * (j % 4)),
                    window=self.source_faces[j]["TKButton"],
                    anchor="nw",
                )
            self.merged_faces_canvas.configure(
                scrollregion=self.merged_faces_canvas.bbox("all")
            )
            ...
            try:
                ...
                if file_type == "image":
                    ...
                    if img is not None:
                        ...
                        if kpss is not None:
                            face_emb, cropped_image = self.models.run_recognize(
                                img, kpss
                            )
                        ...
                        if ret:
                            crop = cv2.cvtColor(
                                ret[0][2].cpu().numpy(), cv2.COLOR_BGR2RGB
                            )
            ...
            if ret:
                ...
                for face in ret:
                    ...
                    for emb in self.target_faces:
                        if (
                            self.findCosineDistance(emb["Embedding"], face[1])
                            < threshhold
                        ):
                            found = True
                            break
                    ...
                    if not found:
                        ...
                        self.target_faces[-1]["TKButton"].config(
                            ...
                            command=lambda k=last_index: self.toggle_found_faces_buttons_state(
                                k
                            ),
                        )
    ...
    def toggle_found_faces_buttons_state(self, button):
        ...
        for i in range(len(self.target_faces[button]["SourceFaceAssignments"])):
            self.source_faces[self.target_faces[button]["SourceFaceAssignments"][i]][
                "ButtonState"
            ] = True
            self.source_faces[self.target_faces[button]["SourceFaceAssignments"][i]][
                "TKButton"
            ].config(style.media_button_on_3)
    ...
    def toggle_source_faces_buttons_state_shift(self, event, button=-1):
        ...
        # Toggle the selected Source Face
        if button != -1:
            self.source_faces[button]["ButtonState"] = not self.source_faces[button][
                "ButtonState"
            ]
    ...
    def populate_target_videos(self):
                    ...
                    try:
                        ...
                        if video.isOpened():
                            ...
                            video.set(
                                ...
                                int(video.get(cv2.CAP_PROP_FRAME_COUNT) / 2),
                            )
                            ...
                            if success:
                                ...
                                ratio = (
                                    float(video_frame.shape[0]) / video_frame.shape[1]
                                )

                                new_height = 50
                                new_width = int(new_height / ratio)
                                video_frame = cv2.resize(
                                    video_frame, (new_width, new_height)
                                )
        ...
        if self.widget["PreviewModeTextSel"].get() == "Image":  # images
            for i in range(len(images)):
                ...
                self.target_media_buttons[i].config(
                    image=self.target_media[i],
                    command=lambda i=i: self.load_target(
                        i, images[i][1], self.widget["PreviewModeTextSel"].get()
                    ),
                )
                self.target_media_buttons[i].bind(
                    "<MouseWheel>", self.target_videos_mouse_wheel
                )
                self.target_media_canvas.create_window(
                    i * 92, 8, window=self.target_media_buttons[i], anchor="nw"
                )

            self.target_media_canvas.configure(
                scrollregion=self.target_media_canvas.bbox("all")
            )
            ...
            for i in range(len(videos)):
                ...
                self.target_media.append(
                    ImageTk.PhotoImage(image=Image.fromarray(videos[i][0]))
                )
                ...
                self.target_media_buttons[i].config(
                    ...
                    anchor="n",
                    command=lambda i=i: self.load_target(
                        i, videos[i][1], self.widget["PreviewModeTextSel"].get()
                    ),
                )
                self.target_media_canvas.create_window(
                    (i % 2) * delx,
                    (i // 2) * dely,
                    window=self.target_media_buttons[i],
                    anchor="nw",
                )
        ...
        if len(image) != 0:
            ...
            if m2 > m1:
                ...
                image = cv2.copyMakeBorder(
                    image, padding, padding, 0, 0, cv2.BORDER_CONSTANT
                )
            else:
                y2 = y1
                x2 = y2 * m2
                ...
                image = cv2.copyMakeBorder(
                    image, 0, 0, padding, padding, cv2.BORDER_CONSTANT
                )
    ...
    def add_action(self, action, parameter=None):  #
        ...
        if (
            action != "get_requested_video_frame"
            and action != "get_requested_video_frame_without_markers"
        ):
    ...
    def iterate_through_merged_embeddings(self, event):
        if event.delta > 0:
            for i in range(len(self.source_faces)):
                if (
                    self.source_faces[i]["ButtonState"]
                    and i < len(self.source_faces) - 1
                ):
    ...
    def update_marker(self, action):
        ...
        if action == "add":
            ...
            position = 20 + int(
                width * self.video_slider.get() / self.video_slider.get_length()
            )
            ...
            temp = {
                ...
                "icon_ref": self.markers_canvas.create_line(
                    position, 0, position, 15, fill="light goldenrod"
                ),
            }
            ...
            if idx > 0:
                ...
                self.add_action(
                    "get_requested_video_frame", self.markers[idx - 1]["frame"]
                )
        ...
        # resize canvas
            ...
            for marker in self.markers:
                position = 20 + int(
                    width * marker["frame"] / self.video_slider.get_length()
                )
                marker["icon_ref"] = self.markers_canvas.create_line(
                    position, 0, position, 15, fill="light goldenrod"
                )
    ...
    def toggle_stop(self):
        if self.stop_marker == self.video_slider.self.timeline_position:
            ...
            position = 15 + int(
                width
                * self.video_slider.self.timeline_position
                / self.video_slider.configure("to")[4]
            )
            self.stop_image = self.video_slider_canvas.create_image(
                position, 30, image=self.stop_marker_icon
            )
    ...
    def save_image(self):
        ...
        cv2.imwrite(
            filename + ".jpg", cv2.cvtColor(self.video_image, cv2.COLOR_BGR2RGB)
        )
