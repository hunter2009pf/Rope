...
LANGUAGE_DOMAIN_NAME = "dicts_trans"
...
DEFAULT_DATA = {
    ...
    "DelEmbedInfoText": _("DELETE EMBEDDING:\nDelete the currently selected embedding"),
    "DelEmbedState": False,
    "DelEmbedText": _("Delete Emb"),
    ...
    "LoadSFacesText": _("Select Faces Folder"),
    ...
    "LoadTVideosInfoText": _(
        "SELECT INPUT VIDEOS/IMAGES FOLDER:\nSelect and load media from folder."
    ),
    "LoadTVideosState": False,
    "LoadTVideosText": _("Select Videos Folder"),
    ...
    "NextMarkerButtonInfoText": _("NEXT MARKER:\nMove to the next marker."),
    ...
    "PrevMarkerButtonInfoText": _("PREVIOUS MARKER:\nMove to the previous marker."),
    ...
    "CLIPSliderAmount": 50,
    "CLIPSliderInc": 1,
    "CLIPSliderInfoText": _(
        "TEXT MASKING THRESHHOLD:\nIncrease to strengthen the effect."
    ),
    "CLIPSliderMax": 100,
    "CLIPSliderMin": 0,
    # Text Selection
    "DetectTypeTextSelInfoText": _(
    ...
    "RestorerDetTypeTextSelInfoText": _(
...
PARAM_VARS = {
    ...
    "CLIPMessage": _(
        "CLIP - Text based occluder. Occluded objects are visible in the final image (occluded from the mask). [LB: on/off, MW: strength]"
    ),
    "CLIPFunction": False,
    "CLIPText": "",
}
...
PARAMS = {
    ...
    "ImgVidMessage": _("IMAGE/VIDEO - Toggle between Image and Video folder view."),
    "ToggleStopMessage": _(
        "STOP MARKER - Sets a frame that will stop the video playing/recording."
    ),
    "AutoSwapMessage": _(
        "AUTO SWAP - Automatically swaps the first person in an image to the selcted source faces [LB: Turn on/off]"
    ),
    "SaveImageMessage": _("SAVE IMAGE - Save image to output folder"),
    "ClearmemMessage": _("CLEAR VRAM - Clears all models from VRAM [LB: Clear]"),
    "PerfTestMessage": _(
        "PERFORMANCE DATA - Displays timing data in the console for critical Rope functions. [LB: on/off]"
    ),
    "RefDelMessage": _(
        "REFERENCE DELTA - Modify the reference points. Turn on mask preview to see adjustments. [LB: on/off, RB: translate x/y, and scale, MW: amount]"
    ),
    "ThresholdMessage": _(
        "THRESHOLD - Threshold for determining if Target Faces match faces in a frame. Lower is stricter. [LB: use amount/match all, MW: value]"
    ),
    "TransformMessage": _(
        "SCALE - Adjust the scale of the face. Use with Background parser to blend into the image. [LB: on/off, MW: amount]"
    ),
    "PlayMessage": _("PLAY - Plays the video. Press again to stop playing"),
}
